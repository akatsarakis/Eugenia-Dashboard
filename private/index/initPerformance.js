...
function initPerformance( state ){
    ...
    performance.read.migration = 0; // <<UNINITIALIZED>>
    performance.read.reconstruction = 0; 	// <<UNINITIALIZED>>


    performance.write.migration = 0; // <<UNINITIALIZED>>
    performance.write.reconstruction = 0; // <<UNINITIALIZED>>
